...
#--Script responsible to get the resist from NCBI trough it's Gi
#--its also responsible to parse the file and get all the relevant information
...
#       //-------------------------------------------\\
	...
	#--Blast with indices, blast can take some time before is completed, doing more then 30 requests at the same time is not good for the server
	...
	#-- method to make blast to all cds, blast method blast may vary 

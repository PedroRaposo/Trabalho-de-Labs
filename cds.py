...
class MyTRNA: # cria uma classe com estes argumentos para guardar a informacao recolhida do NCBI de tRNA
...
class MyCDS: # cria uma classe com estes argumentos para guardar a informacao recolhida do NCBI de CDS
